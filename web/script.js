...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add floating animation to chat preview
    const chatPreview = document.querySelector('.chat-preview');
    if (chatPreview) {
        chatPreview.style.animation = 'float 6s ease-in-out infinite';
    }
    ...
    if (message) {
        ...
        setTimeout(() => {
            const responses = [
                ...
                "I'm here to assist you. Let me provide some information about that.",
